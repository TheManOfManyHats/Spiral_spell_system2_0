...
execute as @s[nbt={SelectedItem:{id:"minecraft:stick",tag:{night_vision_goggles:1b}}}] run function chocolate_datapack:triggers/equipment_system/equip/night_vision_goggles
