execute at @s[scores={growth=4..6}] unless block ~ ~1 ~ wheat run summon item ~ ~ ~ {Item:{id:"minecraft:wither_skeleton_spawn_egg",tag:{EntityTag:{id:armor_stand,Invisible:1b,Marker:1b,Small:1b,DisabledSlots:4144959,Tags:["Custom_Crop","New_Seed","cotton_crop"]},CustomModelData:1,display:{Name:'[{"text":"Cotton Seeds","italic":false}]'}},Count: 1}}
...
execute at @s[scores={growth=7..}] unless block ~ ~1 ~ wheat run summon item ~ ~1 ~ {Item:{id:"minecraft:wither_skeleton_spawn_egg",tag:{EntityTag:{id:armor_stand,Invisible:1b,Marker:1b,Small:1b,DisabledSlots:4144959,Tags:["Custom_Crop","New_Seed","cotton_crop"]},CustomModelData:1,display:{Name:'[{"text":"Cotton Seeds","italic":false}]'}},Count: 2}}
