...
##===================CHECKS======================##
tag @s[tag=grand_wyld_wil_unlocked] add 4
...
tag @s[tag=life_grand_user] add 5
tag @s[tag=wild_grand_user] add 5
tag @s[tag=!2,tag=!3,tag=!4,tag=5] add 1
tag @s[tag=!2,tag=!3,tag=!4,tag=!5] add 6
##===============================================##

##================UNLOCK MESSAGES================##
tellraw @s[tag=1] "Grand Wyld Wil Unlocked!"
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add grand_wyld_wil_unlocked
