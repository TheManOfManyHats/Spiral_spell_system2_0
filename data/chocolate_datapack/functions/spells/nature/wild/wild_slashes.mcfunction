...
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","self","wild","wild_wild_slashes","lv1","new_spell","spiral_spell"],teleport_duration:1}
...
#MED POWER
#Summon armor stand that is the actual attack
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","self","wild","wild_wild_slashes","lv2","new_spell","spiral_spell"],teleport_duration:1}
#Put kill timer on item_display that lasts for 5 seconds
...
#HIGH POWER
#Summon armor stand that is the actual attack
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","self","wild","wild_wild_slashes","lv3","new_spell","spiral_spell"],teleport_duration:1}
#Put kill timer on item_display that lasts for 5 seconds
...
execute at @s[tag=1] positioned ~ ~1.5 ~ run scoreboard players operation @e[tag=wild_wild_slashes,limit=1,sort=nearest,tag=new_spell] player_id = @s[tag=1] player_id
#put player's team ID on the spell
execute at @s[tag=1,scores={team_id=1..}] positioned ~ ~1.5 ~ run scoreboard players operation @e[tag=wild_wild_slashes,limit=1,sort=nearest,tag=new_spell] team_id = @s[tag=1] team_id
#Dramatic flare
...
##-----------------------------------------------------------------##
# Remove tags
execute at @s[tag=1] positioned ~ ~1.5 ~ run tag @e[tag=wild_wild_slashes,sort=nearest,distance=..1,tag=new_spell] remove new_spell
tag @s remove 1