...
##----------------DAMAGING LINES-------------------##
execute at @s[tag=lv1] as @e[type=!#chocolate_datapack:non_activating,limit=1,sort=nearest] rotated as @s at @s run summon item_display ~ ~ ~ {Tags:["offensive","mark","track_prey_effect","lv1"],teleport_duration:1}
execute at @s[tag=lv2] as @e[type=!#chocolate_datapack:non_activating,limit=1,sort=nearest] rotated as @s at @s run summon item_display ~ ~ ~ {Tags:["offensive","mark","track_prey_effect","lv2"],teleport_duration:1}
execute at @s[tag=lv3] as @e[type=!#chocolate_datapack:non_activating,limit=1,sort=nearest] rotated as @s at @s run summon item_display ~ ~ ~ {Tags:["offensive","mark","track_prey_effect","lv3"],teleport_duration:1}
