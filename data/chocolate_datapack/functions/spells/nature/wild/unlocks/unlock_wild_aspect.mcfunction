...
##===================CHECKS======================##
tag @s[tag=life_user,tag=life_grand_user] add 5
tag @s[tag=wild_aspect_unlocked] add 4
...
##================UNLOCK MESSAGES================##
tellraw @s[tag=1] "Wild Aspect Unlocked!"
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add wild_aspect_unlocked
