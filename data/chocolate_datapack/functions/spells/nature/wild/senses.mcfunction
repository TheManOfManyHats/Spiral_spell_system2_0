...
execute as @s[tag=1,scores={spell_power=1}] run effect give @s night_vision 30 0 true
...
execute as @s[tag=1,scores={spell_power=3}] run effect give @s night_vision 60 0 true
...
execute as @s[tag=1,scores={spell_power=5}] run effect give @s night_vision 90 0 true
