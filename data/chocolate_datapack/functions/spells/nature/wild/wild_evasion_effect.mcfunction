...
execute as @s if entity @e[type=#chocolate_datapack:projectile,distance=..3] as @a[distance=..5] at @s if score @s player_id = @e[tag=wild_evasion,distance=..5,limit=1,sort=nearest] player_id run tp @s ^ ^ ^
