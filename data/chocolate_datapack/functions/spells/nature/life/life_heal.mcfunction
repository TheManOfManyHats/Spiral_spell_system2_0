...
execute at @s[tag=1,scores={spell_power=1}] run effect give @s instant_health 1 2 true
execute at @s[tag=1,scores={spell_power=1}] run particle happy_villager ~ ~1 ~ .5 .5 .5 0 20 force
#MED POWER
#Summon armor stand that is the actual attack
execute at @s[tag=1,scores={spell_power=3}] run effect give @s instant_health 1 4 true
execute at @s[tag=1,scores={spell_power=3}] run particle happy_villager ~ ~1 ~ .5 .5 .5 0 20 force
#HIGH POWER
#Summon armor stand that is the actual attack
execute at @s[tag=1,scores={spell_power=5}] run effect give @s instant_health 1 6 true
