...
execute as @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run effect give @s regeneration 30 2 true

#MED POWER
#Summon armor stand that is the actual attack
execute as @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run effect give @s regeneration 60 4 true

#HIGH POWER
#Summon armor stand that is the actual attack
execute as @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run effect give @s regeneration 90 6 true
