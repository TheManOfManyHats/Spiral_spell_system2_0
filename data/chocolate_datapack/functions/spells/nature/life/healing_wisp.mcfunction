...
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run summon allay ~ ~ ~ {HandItems:[{id:"minecraft:air",Count:1b},{}],Invulnerable:1b,Tags:["offensive","summon","life","healing_wisp","lv1","new_spell","spiral_spell"],active_effects:[{id:"minecraft:invisibility",amplifier:0b,duration:2000,show_particles:0b,show_icon:0b,ambient:0b}],CanDuplicate:false,CanPickUpLoot:false}
...
#MED POWER
#Summon armor stand that is the actual attack
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon allay ~ ~ ~ {HandItems:[{id:"minecraft:air",Count:1b},{}],Invulnerable:1b,Tags:["offensive","summon","life","healing_wisp","lv2","new_spell","spiral_spell"],active_effects:[{id:"minecraft:invisibility",amplifier:0b,duration:2000,show_particles:0b,show_icon:0b,ambient:0b}],CanDuplicate:false,CanPickUpLoot:false}
#Put kill timer on item_display that lasts for 5 seconds
...
#HIGH POWER
#Summon armor stand that is the actual attack
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run summon allay ~ ~ ~ {HandItems:[{id:"minecraft:air",Count:1b},{}],Invulnerable:1b,Tags:["offensive","summon","life","healing_wisp","lv3","new_spell","spiral_spell"],active_effects:[{id:"minecraft:invisibility",amplifier:0b,duration:2000,show_particles:0b,show_icon:0b,ambient:0b}],CanDuplicate:false,CanPickUpLoot:false}
#Put kill timer on item_display that lasts for 5 seconds
