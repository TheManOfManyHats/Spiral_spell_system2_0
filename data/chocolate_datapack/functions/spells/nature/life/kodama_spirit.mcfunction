...
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run summon allay ~ ~ ~ {HandItems:[{id:"minecraft:air",Count:1b},{}],Invulnerable:1b,Tags:["offensive","summon","life","kodama_spirit","lv1","new_spell","chocolate_datapack_spell"],active_effects:[{id:"minecraft:invisibility",amplifier:0b,duration:2000,show_particles:0b,show_icon:0b,ambient:0b}],CanDuplicate:false,CanPickUpLoot:false}
