...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add wild_user
tag @s[tag=1] add item_switch
clear @s[tag=1] written_book{CustomModelData:22}
execute as @s[tag=1] run function chocolate_datapack:books/nature/get_wild_book
tag @s[tag=1] remove nature_user
