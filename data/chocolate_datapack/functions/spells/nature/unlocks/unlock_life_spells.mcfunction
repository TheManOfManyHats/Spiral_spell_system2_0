...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add life_user
tag @s[tag=1] add item_switch
clear @s[tag=1] written_book{CustomModelData:22}
execute as @s[tag=1] run function chocolate_datapack:books/nature/get_life_book
