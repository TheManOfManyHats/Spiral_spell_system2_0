...
##===================CHECKS======================##
tag @s[tag=nature_user] add 7
tag @s[tag=life_grand_user] add 6
tag @s[tag=wild_grand_user] add 6
tag @s[tag=life_user] add 4
tag @s[tag=wild_user] add 5
tag @s[tag=!nature_user,tag=!life_user,tag=!wild_user,tag=!life_grand_user,tag=!wild_grand_user] add 2
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1,tag=4] add life_grand_user
tag @s[tag=1,tag=5] add wild_grand_user
clear @s[tag=1,tag=4] written_book{CustomModelData:23}
clear @s[tag=1,tag=5] written_book{CustomModelData:24}
tag @s[tag=1,tag=4] remove life_user
tag @s[tag=1,tag=5] remove wild_user
tag @s[tag=1] add item_switch
execute as @s[tag=1] run function chocolate_datapack:books/nature/get_nature_grand_book
