...
execute at @s[tag=1] positioned ~ ~ ~ run tag @e[tag=aj.living_root.root] add spiral_spell
execute at @s[tag=1] positioned ~ ~ ~ run tag @e[tag=aj.living_root.bone] add spiral_spell
