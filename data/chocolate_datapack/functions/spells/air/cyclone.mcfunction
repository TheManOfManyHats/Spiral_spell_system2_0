...
execute at @s[tag=1,scores={spell_power=1}] run summon armor_stand ~ ~ ~ {Invisible:1b,Invulnerable:1b,Tags:["offensive","wave","cyclone","lv1","new_spell","spiral_spell"],DisabledSlots:4144959}
#MED POWER
execute at @s[tag=1,scores={spell_power=3}] run summon armor_stand ~ ~ ~ {Invisible:1b,Invulnerable:1b,Tags:["offensive","wave","cyclone","lv2","new_spell","spiral_spell"],DisabledSlots:4144959}
#HIGH POWER
execute at @s[tag=1,scores={spell_power=5}] run summon armor_stand ~ ~ ~ {Invisible:1b,Invulnerable:1b,Tags:["offensive","wave","cyclone","lv3","new_spell","spiral_spell"],DisabledSlots:4144959}
