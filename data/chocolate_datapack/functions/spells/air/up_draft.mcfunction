...
execute as @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run effect give @s slow_falling 30 4 true
#HIGH POWER
#Summon armor stand that is the actual attack
execute as @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run effect give @s jump_boost 90 6 true
execute as @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run effect give @s slow_falling 30 6 true
#Dramatic flare
