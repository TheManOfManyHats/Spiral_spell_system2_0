...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add aether_user
tag @s[tag=1] add item_switch
clear @s[tag=1] written_book{CustomModelData:17}
execute as @s[tag=1] run function chocolate_datapack:books/air/get_aether_book
tag @s[tag=1] remove air_user
