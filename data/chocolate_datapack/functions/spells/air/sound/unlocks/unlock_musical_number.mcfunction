...
##===================CHECKS======================##
tag @s[tag=aether_user,tag=aether_grand_user] add 5
tag @s[tag=musical_number_unlocked] add 4
...
##================UNLOCK MESSAGES================##
tellraw @s[tag=1] "Musical Number Unlocked!"
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add musical_number_unlocked
