...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add spellsword_user
tag @s[tag=1] add item_switch
clear @s[tag=1] written_book{CustomModelData:42}
execute as @s[tag=1] run function chocolate_datapack:books/blade/get_spellsword_book
