...
##===================CHECKS======================##
tag @s[tag=blade_user] add 7
tag @s[tag=spellsword_grand_user] add 6
tag @s[tag=antimagic_grand_user] add 6
tag @s[tag=spellsword_user] add 4
tag @s[tag=antimagic_user] add 5
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1,tag=4] add spellsword_grand_user
tag @s[tag=1,tag=5] add antimagic_grand_user
clear @s[tag=1,tag=4] written_book{CustomModelData:43}
clear @s[tag=1,tag=5] written_book{CustomModelData:44}
tag @s[tag=1,tag=4] remove spellsword_user
tag @s[tag=1,tag=5] remove antimagic_user
tag @s[tag=1] add item_switch
execute as @s[tag=1] run function chocolate_datapack:books/blade/get_blade_grand_book
