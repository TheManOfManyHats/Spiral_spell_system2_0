...
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~1 ~ run summon item_display ~ ~ ~ {Tags:["offensive","projectile","blade","crescent_slash","lv1","new_spell","spiral_spell"],teleport_duration:1,item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1014}}}
#MED POWER
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1 ~ run summon item_display ~ ~ ~ {Tags:["offensive","projectile","blade","crescent_slash","lv2","new_spell","spiral_spell"],teleport_duration:1,item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1014}}}
#HIGH POWER
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~1 ~ run summon item_display ~ ~ ~ {Tags:["offensive","projectile","blade","crescent_slash","lv3","new_spell","spiral_spell"],teleport_duration:1,item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1014}}}
