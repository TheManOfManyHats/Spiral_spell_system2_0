...
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~ ~ run summon item_display ~ ~ ~ {item_display:"head",Tags:["offensive","self","blade","parry","lv1","new_spell","spiral_spell"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1019}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,2f,0f],scale:[1f,1f,1f]}}
...
#MED POWER
#Summon armor stand that is the actual attack
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~ ~ run summon item_display ~ ~ ~ {item_display:"head",Tags:["offensive","self","blade","parry","lv2","new_spell","spiral_spell"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1019}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,2f,0f],scale:[1f,1f,1f]}}
#Put kill timer on armorstand that lasts for 5 seconds
...
#HIGH POWER
#Summon armor stand that is the actual attack
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~ ~ run summon item_display ~ ~ ~ {item_display:"head",Tags:["offensive","self","blade","parry","lv3","new_spell","spiral_spell"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1019}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,2f,0f],scale:[1f,1f,1f]}}
#Put kill timer on armorstand that lasts for 5 seconds
