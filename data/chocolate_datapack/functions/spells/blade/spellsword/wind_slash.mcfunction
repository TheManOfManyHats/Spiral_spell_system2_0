...
#LOW POWER
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~ ~ run summon item_display ~ ~2 ~ {item_display:"head",Tags:["offensive","touch","spellsword","blade_wind_slash","lv1","new_spell","chocolate_datapack_spell","spiral_spell"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1020}}}
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run summon armor_stand ~ ~ ~ {Tags:["offensive","lob","spellsword","blade_wind_slash_pusher","lv1","new_spell","chocolate_datapack_spell","spiral_spell"],Invisible:1b,Small:1b,NoBasePlate:1b,Silent:1b}
#MED POWER
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~ ~ run summon item_display ~ ~2 ~ {item_display:"head",Tags:["offensive","touch","spellsword","blade_wind_slash","lv2","new_spell","chocolate_datapack_spell","spiral_spell"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1020}}}
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon armor_stand ~ ~ ~ {Tags:["offensive","lob","spellsword","blade_wind_slash_pusher","lv2","new_spell","chocolate_datapack_spell","spiral_spell"],Invisible:1b,Small:1b,NoBasePlate:1b,Silent:1b}
#HIGH POWER
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~ ~ run summon item_display ~ ~2 ~ {item_display:"head",Tags:["offensive","touch","spellsword","blade_wind_slash","lv3","new_spell","chocolate_datapack_spell","spiral_spell"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1020}}}
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run summon armor_stand ~ ~ ~ {Tags:["offensive","lob","spellsword","blade_wind_slash_pusher","lv3","new_spell","chocolate_datapack_spell","spiral_spell"],Invisible:1b,Small:1b,NoBasePlate:1b,Silent:1b}
