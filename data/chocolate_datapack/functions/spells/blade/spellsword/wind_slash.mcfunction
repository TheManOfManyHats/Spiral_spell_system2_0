...
#execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~ ~ run summon item_display ~ ~2 ~ {item_display:"head",Tags:["offensive","touch","spellsword","blade_wind_slash","lv1","new_spell"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1020}}}
#execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run summon armor_stand ~ ~ ~ {Tags:["offensive","lob","spellsword","blade_wind_slash_pusher]","lv1","new_spell"],Small:1b,Invisible:1b,Invulnerable:1b}
#
##MED POWER
#execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~ ~ run summon item_display ~ ~2 ~ {item_display:"head",Tags:["offensive","touch","spellsword","blade_wind_slash","lv2","new_spell"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1020}}}
#execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon armor_stand ~ ~ ~ {Tags:["offensive","lob","spellsword","blade_wind_slash_pusher]","lv2","new_spell"],Small:1b,Invisible:1b,Invulnerable:1b}
#
##HIGH POWER
#execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~ ~ run summon item_display ~ ~2 ~ {item_display:"head",Tags:["offensive","touch","spellsword","blade_wind_slash","lv3","new_spell"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1020}}}
#execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run summon armor_stand ~ ~ ~ {Tags:["offensive","lob","spellsword","blade_wind_slash_pusher]","lv3","new_spell"],Small:1b,Invisible:1b,Invulnerable:1b}
#
...
#execute at @s[tag=1] positioned ~ ~1.5 ~ run scoreboard players set @e[tag=blade_wind_slash_pusher,sort=nearest,distance=..1,tag=new_spell] kill_timer 20
...
#execute at @s[tag=1] positioned ~ ~1.5 ~ run scoreboard players operation @e[tag=blade_wind_slash_pusher,distance=..1,sort=nearest,tag=new_spell] player_id = @s[tag=1] player_id
...
#execute at @s[tag=1,scores={team_id=1..}] positioned ~ ~1.5 ~ run scoreboard players operation @e[tag=blade_wind_slash_pusher,distance=..1,sort=nearest,tag=new_spell] team_id = @s[tag=1] team_id
...
#execute at @s[tag=1] rotated as @s positioned ~ ~1.5 ~ run tp @e[tag=blade_wind_slash_pusher,sort=nearest,limit=1,tag=new_spell] ~ ~ ~ ~ ~
...
#
## Remove tags
#execute at @s[tag=1] positioned ~ ~2 ~ run tag @e[tag=blade_wind_slash,sort=nearest,distance=..1,tag=new_spell] remove new_spell
#tag @s remove 1
...
#LOW POWER
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~ ~ run summon item_display ~ ~2 ~ {item_display:"head",Tags:["offensive","touch","spellsword","blade_wind_slash","lv1","new_spell"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1020}}}
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run summon armor_stand ~ ~ ~ {Tags:["offensive","lob","spellsword","blade_wind_slash_pusher","lv1","new_spell"],Invisible:1b,Small:1b,NoBasePlate:1b,Silent:1b}
#MED POWER
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~ ~ run summon item_display ~ ~2 ~ {item_display:"head",Tags:["offensive","touch","spellsword","blade_wind_slash","lv2","new_spell"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1020}}}
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon armor_stand ~ ~ ~ {Tags:["offensive","lob","spellsword","blade_wind_slash_pusher","lv2","new_spell"],Invisible:1b,Small:1b,NoBasePlate:1b,Silent:1b}
#HIGH POWER
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~ ~ run summon item_display ~ ~2 ~ {item_display:"head",Tags:["offensive","touch","spellsword","blade_wind_slash","lv3","new_spell"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1020}}}
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run summon armor_stand ~ ~ ~ {Tags:["offensive","lob","spellsword","blade_wind_slash_pusher","lv3","new_spell"],Invisible:1b,Small:1b,NoBasePlate:1b,Silent:1b}
