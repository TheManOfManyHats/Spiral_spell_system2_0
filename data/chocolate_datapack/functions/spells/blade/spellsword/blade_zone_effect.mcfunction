##----------------DAMAGING LINES-------------------##
execute at @s[tag=lv1] run summon item_display ~ ~ ~ {Tags:["zone","spell_sword","offensive","blade_zone_zone","lv1","chocolate_datapack_spell","spiral_spell"]}
execute at @s[tag=lv2] run summon item_display ~ ~ ~ {Tags:["zone","spell_sword","offensive","blade_zone_zone","lv2","chocolate_datapack_spell","spiral_spell"]}
execute at @s[tag=lv3] run summon item_display ~ ~ ~ {Tags:["zone","spell_sword","offensive","blade_zone_zone","lv3","chocolate_datapack_spell","spiral_spell"]}
