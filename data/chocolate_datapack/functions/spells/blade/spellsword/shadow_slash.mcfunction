...
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~ ~ run summon item_display ~ ~2 ~ {item_display:"head",Tags:["offensive","touch","spellsword","shadow_slash","lv1","new_spell"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1072}}}

#MED POWER
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~ ~ run summon item_display ~ ~2 ~ {item_display:"head",Tags:["offensive","touch","spellsword","shadow_slash","lv2","new_spell"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1072}}}

#HIGH POWER
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~ ~ run summon item_display ~ ~2 ~ {item_display:"head",Tags:["offensive","touch","spellsword","shadow_slash","lv3","new_spell"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1072}}}
