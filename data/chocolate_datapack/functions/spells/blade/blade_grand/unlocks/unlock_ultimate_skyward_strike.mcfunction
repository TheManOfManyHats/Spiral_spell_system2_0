...
##===================CHECKS======================##
tag @s[tag=ultimate_skyward_strike_unlocked] add 4
...
tag @s[tag=spellsword_grand_user] add 5
tag @s[tag=antimagic_grand_user] add 5
tag @s[tag=!2,tag=!3,tag=!4,tag=5] add 1
tag @s[tag=!2,tag=!3,tag=!4,tag=!5] add 6
##===============================================##

##================UNLOCK MESSAGES================##
tellraw @s[tag=1] "Ultimate Skyward Strike Unlocked!"
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add ultimate_skyward_strike_unlocked
