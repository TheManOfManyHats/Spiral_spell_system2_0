...
##===================CHECKS======================##
tag @s[tag=spellsword_user,tag=spellsword_grand_user] add 5
tag @s[tag=draining_zone_unlocked] add 4
...
##================UNLOCK MESSAGES================##
tellraw @s[tag=1] "Draining Zone Unlocked!"
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add draining_zone_unlocked
