...
execute as @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run effect give @s minecraft:speed 30 3 true
execute as @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run effect give @s minecraft:jump_boost 30 0 true
#MED POWER
#Summon armor stand that is the actual attack
execute as @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run effect give @s minecraft:speed 60 6 true
execute as @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run effect give @s minecraft:jump_boost 60 0 true
#HIGH POWER
#Summon armor stand that is the actual attack
execute as @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run effect give @s minecraft:speed 90 9 true
execute as @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run effect give @s minecraft:jump_boost 90 0 true
