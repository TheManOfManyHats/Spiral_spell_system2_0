...
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run summon marker ~ ~ ~ {Tags:["offensive","homing","fierro","fierros_fiery","lv1","new_spell"]}
#MED POWER
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon marker ~ ~ ~ {Tags:["offensive","homing","fierro","fierros_fiery","lv2","new_spell"]}
#HIGH POWER
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run summon marker ~ ~ ~ {Tags:["offensive","homing","fierro","fierros_fiery","lv3","new_spell"]}
