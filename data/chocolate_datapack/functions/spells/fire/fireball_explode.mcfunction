...
##----------------VISUAL EFFECTS-------------------##
execute at @s[tag=lv1,tag=nova] run particle soul_fire_flame ~ ~ ~ .1 .1 1 .1 100 force
execute at @s[tag=lv1,tag=!nova] run particle flame ~ ~ ~ .1 .1 1 .1 100 force
...
execute at @s[tag=lv2,tag=nova] run particle soul_fire_flame ~ ~ ~ .5 .5 .5 1 200 force
execute at @s[tag=lv2,tag=!nova] run particle flame ~ ~ ~ .5 .5 .5 1 200 force
...
execute at @s[tag=lv3,tag=nova] run particle soul_fire_flame ~ ~ ~ 1 1 1 1 300 force
execute at @s[tag=lv3,tag=!nova] run particle flame ~ ~ ~ 1 1 1 1 300 force
