...
##===================CHECKS======================##
tag @s[tag=fire_user] add 7
tag @s[tag=lightning_grand_user] add 6
tag @s[tag=magma_grand_user] add 6
tag @s[tag=lightning_user] add 4
tag @s[tag=magma_user] add 5
tag @s[tag=!fire_user,tag=!lightning_user,tag=!magma_user,tag=!lightning_grand_user,tag=!magma_grand_user] add 2
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1,tag=4] add lightning_grand_user
tag @s[tag=1,tag=5] add magma_grand_user
clear @s[tag=1,tag=4] written_book{CustomModelData:3}
clear @s[tag=1,tag=5] written_book{CustomModelData:4}
tag @s[tag=1,tag=4] remove lightning_user
tag @s[tag=1,tag=5] remove magma_user
tag @s[tag=1] add item_switch
execute as @s[tag=1] run function chocolate_datapack:books/fire/get_fire_grand_book
