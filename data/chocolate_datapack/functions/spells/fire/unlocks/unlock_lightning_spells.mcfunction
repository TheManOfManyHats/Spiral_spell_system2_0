...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add lightning_user
tag @s[tag=1] add item_switch
clear @s[tag=1] written_book{CustomModelData:2}
execute as @s[tag=1] run function chocolate_datapack:books/fire/get_lightning_book
tag @s[tag=1] remove fire_user
