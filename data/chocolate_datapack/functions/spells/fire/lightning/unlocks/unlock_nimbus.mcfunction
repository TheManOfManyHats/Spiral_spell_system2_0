...
##===================CHECKS======================##
tag @s[tag=magma_user,tag=magma_grand_user] add 5
tag @s[tag=nimbus_unlocked] add 4
tag @s[tag=!lightning_user,tag=!lightning_grand_user] add 2
execute if score @s skill_points < @s unlock_cost run tag @s add 3
tag @s[tag=!2,tag=!3,tag=!4,tag=!5] add 1
##===============================================##

##================UNLOCK MESSAGES================##
tellraw @s[tag=1] "Nimbus Unlocked!"
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add nimbus_unlocked
