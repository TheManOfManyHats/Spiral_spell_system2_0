...
#LOW POWER
execute at @s[tag=1,scores={spell_power=1},tag=!goatboi] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","projectile","fire","fire_ball","lv1","new_spell","chocolate_datapack_spell"],teleport_duration:1}
#MED POWER
execute at @s[tag=1,scores={spell_power=3},tag=!goatboi] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","projectile","fire","fire_ball","lv2","new_spell","chocolate_datapack_spell"],teleport_duration:1}
#HIGH POWER
