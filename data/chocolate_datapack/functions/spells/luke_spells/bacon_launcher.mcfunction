...
#LOW POWER
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run summon pig ~ ~ ~ {Tags:["offensive","projectile","luke_spells","bacon_launcher","lv1","new_spell","spiral_spell"]}
#MED POWER
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon pig ~ ~ ~ {Tags:["offensive","projectile","luke_spells","bacon_launcher","lv2","new_spell","spiral_spell"]}
#HIGH POWER
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run summon pig ~ ~ ~ {Tags:["offensive","projectile","luke_spells","bacon_launcher","lv3","new_spell","spiral_spell"]}
