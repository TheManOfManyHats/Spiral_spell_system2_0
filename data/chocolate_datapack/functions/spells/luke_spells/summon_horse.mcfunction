...
#LOW POWER
execute at @s[tag=1,scores={spell_power=1}] at @e[type=horse,tag=luke_horse] run particle electric_spark ~ ~.5 ~ 1 1 1 1 500 force
...
execute at @s[tag=1,scores={spell_power=1}] run summon horse ^ ^ ^5 {Tags:["luke_horse"]}
execute at @s[tag=1,scores={spell_power=1}] at @e[type=horse,tag=luke_horse] run particle electric_spark ~ ~.5 ~ 1 1 1 1 500 force
...
#MED POWER
execute at @s[tag=1,scores={spell_power=3}] at @e[type=horse,tag=luke_horse] run particle electric_spark ~ ~.5 ~ 1 1 1 1 500 force
...
execute at @s[tag=1,scores={spell_power=3}] run summon horse ^ ^ ^5 {Tags:["luke_horse"]}
execute at @s[tag=1,scores={spell_power=3}] at @e[type=horse,tag=luke_horse] run particle electric_spark ~ ~.5 ~ 1 1 1 1 500 force
...
#HIGH POWER
execute at @s[tag=1,scores={spell_power=5}] at @e[type=horse,tag=luke_horse] run particle electric_spark ~ ~.5 ~ 1 1 1 1 500 force
...
execute at @s[tag=1,scores={spell_power=5}] run summon horse ^ ^ ^5 {Tags:["luke_horse"]}
execute at @s[tag=1,scores={spell_power=5}] at @e[type=horse,tag=luke_horse] run particle electric_spark ~ ~.5 ~ 1 1 1 1 500 force
