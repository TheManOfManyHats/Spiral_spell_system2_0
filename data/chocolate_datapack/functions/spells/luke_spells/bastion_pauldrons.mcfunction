...
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run summon armor_stand ~ ~ ~ {ShowArms:1b,DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:stick",Count:1,tag:{CustomModelData:11}}],Invisible:1b,Invulnerable:1b,Tags:["offensive","self","luke_spell","bastion","lv1","new_spell","chocolate_datapack_spell"]}
...
#MED POWER
#Summon armor stand that is the actual attack
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon armor_stand ~ ~ ~ {ShowArms:1b,DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:stick",Count:1,tag:{CustomModelData:11}}],Invisible:1b,Invulnerable:1b,Tags:["offensive","self","luke_spell","bastion","lv2","new_spell","chocolate_datapack_spell"]}
#Put kill timer on item_display that lasts for 5 seconds
...
#HIGH POWER
#Summon armor stand that is the actual attack
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run summon armor_stand ~ ~ ~ {ShowArms:1b,DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:stick",Count:1,tag:{CustomModelData:11}}],Invisible:1b,Invulnerable:1b,Tags:["offensive","self","luke_spell","bastion","lv3","new_spell","chocolate_datapack_spell"]}
#Put kill timer on item_display that lasts for 5 seconds
