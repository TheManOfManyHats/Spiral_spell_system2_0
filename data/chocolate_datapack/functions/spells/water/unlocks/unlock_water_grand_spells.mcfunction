...
##===================CHECKS======================##
tag @s[tag=water_user] add 7
tag @s[tag=ice_grand_user] add 6
tag @s[tag=healing_grand_user] add 6
tag @s[tag=ice_user] add 4
tag @s[tag=healing_user] add 5
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1,tag=4] add ice_grand_user
tag @s[tag=1,tag=5] add healing_grand_user
clear @s[tag=1,tag=4] written_book{CustomModelData:8}
clear @s[tag=1,tag=5] written_book{CustomModelData:9}
tag @s[tag=1,tag=4] remove ice_user
tag @s[tag=1,tag=5] remove healing_user
tag @s[tag=1] add item_switch
execute as @s[tag=1] run function chocolate_datapack:books/water/get_water_grand_book
