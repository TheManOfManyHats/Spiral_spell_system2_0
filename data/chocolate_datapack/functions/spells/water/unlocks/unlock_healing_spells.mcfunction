...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add healing_user
tag @s[tag=1] add item_switch
clear @s[tag=1] written_book{CustomModelData:7}
execute as @s[tag=1] run function chocolate_datapack:books/water/get_healing_book
