##----------------DAMAGING LINES-------------------##
execute at @s[tag=lv1] run summon item_display ~ ~ ~ {Tags:["zone","water","offensive","water_prison_zone","lv1","chocolate_datapack_spell"]}
execute at @s[tag=lv2] run summon item_display ~ ~ ~ {Tags:["zone","water","offensive","water_prison_zone","lv2","chocolate_datapack_spell"]}
execute at @s[tag=lv3] run summon item_display ~ ~ ~ {Tags:["zone","water","offensive","water_prison_zone","lv3","chocolate_datapack_spell"]}
