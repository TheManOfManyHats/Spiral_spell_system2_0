...
execute at @s[tag=1,scores={spell_power=1}] run summon armor_stand ~ ~ ~ {Invisible:1b,Invulnerable:1b,Tags:["offensive","wave","water","water_wave","lv1","new_spell","chocolate_datapack_spell"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:stick",tag:{CustomModelData:1048},Count:1}]}
#MED POWER
execute at @s[tag=1,scores={spell_power=3}] run summon armor_stand ~ ~ ~ {Invisible:1b,Invulnerable:1b,Tags:["offensive","wave","water","water_wave","lv2","new_spell","chocolate_datapack_spell"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:stick",tag:{CustomModelData:1049},Count:1}]}
#HIGH POWER
execute at @s[tag=1,scores={spell_power=5}] run summon armor_stand ~ ~ ~ {Invisible:1b,Invulnerable:1b,Tags:["offensive","wave","water","water_wave","lv3","new_spell","chocolate_datapack_spell"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:stick",tag:{CustomModelData:1050},Count:1}]}
