...
##===================CHECKS======================##
tag @s[tag=gift_of_neptune_unlocked] add 4
...
tag @s[tag=ice_grand_user] add 5
tag @s[tag=healing_grand_user] add 5
tag @s[tag=!2,tag=!3,tag=!4,tag=5] add 1
tag @s[tag=!2,tag=!3,tag=!4,tag=!5] add 6
##===============================================##

##================UNLOCK MESSAGES================##
tellraw @s[tag=1] "Gift Of Neptune Unlocked!"
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add gift_of_neptune_unlocked
