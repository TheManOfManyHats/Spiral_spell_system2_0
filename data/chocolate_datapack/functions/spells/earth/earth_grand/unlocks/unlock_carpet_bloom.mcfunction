...
##===================CHECKS======================##
tag @s[tag=carpet_bloom_unlocked] add 4
...
tag @s[tag=metal_grand_user] add 5
tag @s[tag=crystal_grand_user] add 5
tag @s[tag=!2,tag=!3,tag=!4,tag=5] add 1
tag @s[tag=!2,tag=!3,tag=!4,tag=!5] add 6
##===============================================##

##================UNLOCK MESSAGES================##
tellraw @s[tag=1] "Carpet Bloom Unlocked!"
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add carpet_bloom_unlocked
