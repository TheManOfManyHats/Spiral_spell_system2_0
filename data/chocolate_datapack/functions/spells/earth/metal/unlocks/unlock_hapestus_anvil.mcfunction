...
##===================CHECKS======================##
tag @s[tag=crystal_user,tag=crystal_grand_user] add 5
tag @s[tag=hapestus_anvil_unlocked] add 4
...
##================UNLOCK MESSAGES================##
tellraw @s[tag=1] "Hapestus Anvil Unlocked!"
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add hapestus_anvil_unlocked
