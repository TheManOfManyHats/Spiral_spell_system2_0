...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add metal_user
tag @s[tag=1] add item_switch
clear @s[tag=1] written_book{CustomModelData:12}
execute as @s[tag=1] run function chocolate_datapack:books/earth/get_metal_book
