...
execute at @s[tag=lv1] run tag @e[tag=new,distance=..2] add chocolate_datapack_spell
...
execute at @s[tag=lv2] run tag @e[tag=new,distance=..3] add chocolate_datapack_spell
...
execute at @s[tag=lv3] run tag @e[tag=new,distance=..4] add chocolate_datapack_spell
