...
#LOW POWER
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","projectile","time","prediction_blast","lv1","new_spell","spiral_spell"],teleport_duration:1}
#MED POWER
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","projectile","time","prediction_blast","lv2","new_spell","spiral_spell"],teleport_duration:1}
#HIGH POWER
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","projectile","time","prediction_blast","lv3","new_spell","spiral_spell"],teleport_duration:1}
