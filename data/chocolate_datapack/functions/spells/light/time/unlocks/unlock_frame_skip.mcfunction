...
##===================CHECKS======================##
tag @s[tag=celestial_user,tag=celestial_grand_user] add 5
tag @s[tag=frame_skip_unlocked] add 4
...
##================UNLOCK MESSAGES================##
tellraw @s[tag=1] "Frame Skip Unlocked!"
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add frame_skip_unlocked
