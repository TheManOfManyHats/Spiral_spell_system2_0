...
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","zone","light","light_judgement","lv1","new_spell","spiral_spell"],teleport_duration:1}
#MED POWER
#Summon armor stand that is the actual attack
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","zone","light","light_judgement","lv2","new_spell","spiral_spell"],teleport_duration:1}
#HIGH POWER
#Summon armor stand that is the actual attack
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","zone","light","light_judgement","lv3","new_spell","spiral_spell"],teleport_duration:1}
