...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add celestial_user
tag @s[tag=1] add item_switch
clear @s[tag=1] written_book{CustomModelData:32}
execute as @s[tag=1] run function chocolate_datapack:books/light/get_celestial_book
