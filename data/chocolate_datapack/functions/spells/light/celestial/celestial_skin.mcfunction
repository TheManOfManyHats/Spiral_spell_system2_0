...
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","self","celestial","celestial_skin","lv1","new_spell","spiral_spell"],teleport_duration:1}
...
#MED POWER
#Summon armor stand that is the actual attack
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","self","celestial","celestial_skin","lv2","new_spell","spiral_spell"],teleport_duration:1}
#Put kill timer on item_display that lasts for 5 seconds
...
#HIGH POWER
#Summon armor stand that is the actual attack
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","self","celestial","celestial_skin","lv3","new_spell","spiral_spell"],teleport_duration:1}
#Put kill timer on item_display that lasts for 5 seconds
