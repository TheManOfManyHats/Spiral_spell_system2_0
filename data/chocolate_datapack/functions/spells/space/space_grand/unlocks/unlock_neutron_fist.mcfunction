...
##===================CHECKS======================##
tag @s[tag=neutron_fist_unlocked] add 4
...
tag @s[tag=void_grand_user] add 5
tag @s[tag=chaos_grand_user] add 5
tag @s[tag=!2,tag=!3,tag=!4,tag=5] add 1
tag @s[tag=!2,tag=!3,tag=!4,tag=!5] add 6
##===============================================##

##================UNLOCK MESSAGES================##
tellraw @s[tag=1] "Neutron Fist Unlocked!"
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add neutron_fist_unlocked
