...
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~ ~ run summon item_display ~ ~ ~ {Tags:["offensive","mark","space","rift","lv1","new_spell","chocolate_datapack_spell"],teleport_duration:1,item_display:"head",item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1041}},brightness:{block:15,sky:15}}
execute at @s[tag=1,scores={spell_power=1}] as @e[tag=mark_spell,tag=lv1] if score @s player_id = @a[tag=1,limit=1,sort=nearest] player_id at @s unless entity @e[tag=rift_return,distance=..1,tag=lv1] run summon item_display ~ ~1 ~ {Tags:["offensive","mark","space","rift_return","lv1","new_spell","chocolate_datapack_spell"],teleport_duration:1,item_display:"head",item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1041}},brightness:{block:15,sky:15}}
...
#MED POWER
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~ ~ run summon item_display ~ ~ ~ {Tags:["offensive","mark","space","rift","lv2","new_spell","chocolate_datapack_spell"],teleport_duration:1,item_display:"head",item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1041}},brightness:{block:15,sky:15}}
execute at @s[tag=1,scores={spell_power=3}] as @e[tag=mark_spell,tag=lv2] if score @s player_id = @a[tag=1,limit=1,sort=nearest] player_id at @s unless entity @e[tag=rift_return,distance=..1,tag=lv2] run summon item_display ~ ~1 ~ {Tags:["offensive","mark","space","rift_return","lv2","new_spell","chocolate_datapack_spell"],teleport_duration:1,item_display:"head",item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1041}},brightness:{block:15,sky:15}}
...
#HIGH POWER
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~ ~ run summon item_display ~ ~ ~ {Tags:["offensive","mark","space","rift","lv3","new_spell","chocolate_datapack_spell"],teleport_duration:1,item_display:"head",item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1041}},brightness:{block:15,sky:15}}
execute at @s[tag=1,scores={spell_power=5}] as @e[tag=mark_spell,tag=lv3] if score @s player_id = @a[tag=1,limit=1,sort=nearest] player_id at @s unless entity @e[tag=rift_return,distance=..1,tag=lv3] run summon item_display ~ ~1 ~ {Tags:["offensive","mark","space","rift_return","lv3","new_spell","chocolate_datapack_spell"],teleport_duration:1,item_display:"head",item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1041}},brightness:{block:15,sky:15}}
