...
execute as @s[tag=1,scores={spell_power=1}] at @s positioned ~ ~1 ~ run particle sonic_boom ~ ~ ~ 0 0 0 0 1 force
execute as @s[tag=1,scores={spell_power=1}] at @s run tp @s ^ ^ ^5
execute as @s[tag=1,scores={spell_power=1}] at @s positioned ~ ~1 ~ run particle sonic_boom ~ ~ ~ 0 0 0 0 1 force
#MED POWER
#Summon armor stand that is the actual attack
execute as @s[tag=1,scores={spell_power=3}] at @s positioned ~ ~1 ~ run particle sonic_boom ~ ~ ~ 0 0 0 0 1 force
execute as @s[tag=1,scores={spell_power=3}] at @s run tp @s ^ ^ ^10
execute as @s[tag=1,scores={spell_power=3}] at @s positioned ~ ~1 ~ run particle sonic_boom ~ ~ ~ 0 0 0 0 1 force
#HIGH POWER
#Summon armor stand that is the actual attack
execute as @s[tag=1,scores={spell_power=5}] at @s positioned ~ ~1 ~ run particle sonic_boom ~ ~ ~ 0 0 0 0 1 force
