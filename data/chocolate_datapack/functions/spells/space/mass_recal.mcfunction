...
execute as @s[tag=1,scores={spell_power=1}] at @s as @e[type=marker,tag=mark_spell,tag=lv1] if score @s player_id = @a[tag=1,limit=1,sort=nearest] player_id run tp @e[type=!#chocolate_datapack:non_activating,distance=..3,sort=nearest] @s
...
execute as @s[tag=1,scores={spell_power=3}] at @s as @e[type=marker,tag=mark_spell,tag=lv2] if score @s player_id = @a[tag=1,limit=1,sort=nearest] player_id run tp @e[type=!#chocolate_datapack:non_activating,distance=..3,sort=nearest] @s
...
execute as @s[tag=1,scores={spell_power=5}] at @s as @e[type=marker,tag=mark_spell,tag=lv3] if score @s player_id = @a[tag=1,limit=1,sort=nearest] player_id run tp @e[type=!#chocolate_datapack:non_activating,distance=..3,sort=nearest] @s
