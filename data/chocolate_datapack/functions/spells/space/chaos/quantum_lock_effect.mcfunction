...
##----------------DAMAGING LINES-------------------##
execute at @s as @e[type=!#chocolate_datapack:non_activating,limit=1,sort=nearest] rotated as @s at @s run summon armor_stand ~ ~ ~ {Tags:["offensive","mark","quantum_lock_effect","chaos","chocolate_datapack_spell"],Invisible:1b,Invulnerable:1b}
