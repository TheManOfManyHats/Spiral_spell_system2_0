...
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","lance","chaos","chaos_spear","lv1","new_spell"],teleport_duration:1,item_display:"head",item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1042}}}
#MED POWER
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","lance","chaos","chaos_spear","lv2","new_spell"],teleport_duration:1,item_display:"head",item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1043}}}
#HIGH POWER
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run summon item_display ~ ~ ~ {Tags:["offensive","lance","chaos","chaos_spear","lv3","new_spell"],teleport_duration:1,item_display:"head",item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1044}}}
