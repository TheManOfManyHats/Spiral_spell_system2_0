...
execute at @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run summon marker ~ ~ ~ {Tags:["offensive","bolt","void","reality_slip","lv1","new_spell","spiral_spell"]}
#MED POWER
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon marker ~ ~ ~ {Tags:["offensive","bolt","void","reality_slip","lv2","new_spell","spiral_spell"]}
#HIGH POWER
execute at @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run summon marker ~ ~ ~ {Tags:["offensive","bolt","void","reality_slip","lv3","new_spell","spiral_spell"]}
