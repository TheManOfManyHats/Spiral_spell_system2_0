...
##----------------DAMAGING LINES-------------------##
execute at @s as @e[type=!#chocolate_datapack:non_activating,limit=1,sort=nearest] rotated as @s at @s run summon armor_stand ~ ~ ~ {Tags:["offensive","mark","reality_slip_effect","chocolate_datapack_spell"],Invisible:1b,Invulnerable:1b}
