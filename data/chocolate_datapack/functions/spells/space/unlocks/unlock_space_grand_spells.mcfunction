...
##===================CHECKS======================##
tag @s[tag=space_user] add 7
tag @s[tag=void_grand_user] add 6
tag @s[tag=chaos_grand_user] add 6
tag @s[tag=void_user] add 4
tag @s[tag=chaos_user] add 5
tag @s[tag=!space_user,tag=!void_user,tag=!chaos_user,tag=!void_grand_user,tag=!chaos_grand_user] add 2
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1,tag=4] add void_grand_user
tag @s[tag=1,tag=5] add chaos_grand_user
clear @s[tag=1,tag=4] written_book{CustomModelData:37}
clear @s[tag=1,tag=5] written_book{CustomModelData:38}
tag @s[tag=1,tag=4] remove void_user
tag @s[tag=1,tag=5] remove chaos_user
tag @s[tag=1] add item_switch
execute as @s[tag=1] run function chocolate_datapack:books/space/get_space_grand_book
