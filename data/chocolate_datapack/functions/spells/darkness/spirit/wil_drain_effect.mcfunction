##----------------DAMAGING LINES-------------------##
execute at @s[tag=lv1] run summon item_display ~ ~ ~ {Tags:["zone","spirit","offensive","wil_drain_zone_zone","lv1"]}
execute at @s[tag=lv2] run summon item_display ~ ~ ~ {Tags:["zone","spirit","offensive","wil_drain_zone_zone","lv2"]}
execute at @s[tag=lv3] run summon item_display ~ ~ ~ {Tags:["zone","spirit","offensive","wil_drain_zone_zone","lv3"]}
