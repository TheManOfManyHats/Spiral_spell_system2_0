...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add death_user
tag @s[tag=1] add item_switch
clear @s[tag=1] written_book{CustomModelData:27}
execute as @s[tag=1] run function chocolate_datapack:books/darkness/get_death_book
