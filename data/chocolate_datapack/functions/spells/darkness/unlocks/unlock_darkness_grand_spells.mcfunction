...
##===================CHECKS======================##
tag @s[tag=darkness_user] add 7
tag @s[tag=death_grand_user] add 6
tag @s[tag=spirit_grand_user] add 6
tag @s[tag=death_user] add 4
tag @s[tag=spirit_user] add 5
tag @s[tag=!darkness_user,tag=!death_user,tag=!spirit_user,tag=!death_grand_user,tag=!spirit_grand_user] add 2
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1,tag=4] add death_grand_user
tag @s[tag=1,tag=5] add spirit_grand_user
clear @s[tag=1,tag=4] written_book{CustomModelData:27}
clear @s[tag=1,tag=5] written_book{CustomModelData:28}
tag @s[tag=1,tag=4] remove death_user
tag @s[tag=1,tag=5] remove spirit_user
tag @s[tag=1] add item_switch
execute as @s[tag=1] run function chocolate_datapack:books/darkness/get_darkness_grand_book
