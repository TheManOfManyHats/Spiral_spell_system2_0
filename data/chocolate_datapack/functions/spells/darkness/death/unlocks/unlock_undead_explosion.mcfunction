...
scoreboard players set @s unlock_cost 30
##===============================================##

##===================CHECKS======================##
tag @s[tag=spirit_user,tag=spirit_grand_user] add 5
tag @s[tag=undead_explosion_unlocked] add 4
...
##================UNLOCK MESSAGES================##
tellraw @s[tag=1] "Undead Explosion Unlocked!"
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add undead_explosion_unlocked
