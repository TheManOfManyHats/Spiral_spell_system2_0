...
execute as @s[tag=1,scores={spell_power=1}] positioned ~ ~1.5 ~ run effect give @s night_vision 30 0 true
#MED POWER
#Summon armor stand that is the actual attack
execute as @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run effect give @s night_vision 60 0 true
#HIGH POWER
#Summon armor stand that is the actual attack
execute as @s[tag=1,scores={spell_power=5}] positioned ~ ~1.5 ~ run effect give @s night_vision 90 0 true
#Dramatic flare
execute at @s[tag=1] run playsound entity.vex.death ambient @a ~ ~ ~ 1 1
execute at @s[tag=1] run particle squid_ink ~ ~1 ~ .3 .5 .3 .1 20 force
##-----------------------------------------------------------------##
