...
##===================CHECKS======================##
tag @s[tag=spirit_storm_unlocked] add 4
...
tag @s[tag=death_grand_user] add 5
tag @s[tag=spirit_grand_user] add 5
tag @s[tag=!2,tag=!3,tag=!4,tag=5] add 1
tag @s[tag=!2,tag=!3,tag=!4,tag=!5] add 6
##===============================================##

##================UNLOCK MESSAGES================##
tellraw @s[tag=1] "Spirit Storm Unlocked!"
...
##===============UNLOCK THE SPELL================##
tag @s[tag=1] add spirit_storm_unlocked
