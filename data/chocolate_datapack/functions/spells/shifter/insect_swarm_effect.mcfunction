##----------------DAMAGING LINES-------------------##
execute at @s[tag=lv1] as @e[type=!#chocolate_datapack:non_activating,distance=..1] unless score @s player_id = @e[limit=1,sort=nearest,tag=insect_swarm,distance=..2] player_id unless score @s team_id = @e[tag=insect_swarm,sort=nearest,limit=1,distance=..1] team_id run effect give poison @s 1 on_fire
...
execute at @s[tag=lv2] as @e[type=!#chocolate_datapack:non_activating,distance=..2] unless score @s player_id = @e[limit=1,sort=nearest,tag=insect_swarm,distance=..2] player_id unless score @s team_id = @e[tag=insect_swarm,sort=nearest,limit=1,distance=..1] team_id run effect give poison @s 2 on_fire
...
execute at @s[tag=lv3] as @e[type=!#chocolate_datapack:non_activating,distance=..3] unless score @s player_id = @e[limit=1,sort=nearest,tag=insect_swarm,distance=..2] player_id unless score @s team_id = @e[tag=insect_swarm,sort=nearest,limit=1,distance=..1] team_id run effect give poison @s 3 on_fire
