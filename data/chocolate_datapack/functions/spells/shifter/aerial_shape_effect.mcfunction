...
execute at @s[tag=lv1] as @a if score @s player_id = @e[limit=1,sort=nearest,tag=aquatic_shape] player_id run effect give @s slow_falling 1 255 true
...
execute at @s[tag=lv2] as @a if score @s player_id = @e[limit=1,sort=nearest,tag=aquatic_shape] player_id run effect give @s slow_falling 1 255 true
...
execute at @s[tag=lv3] as @a if score @s player_id = @e[limit=1,sort=nearest,tag=aquatic_shape] player_id run effect give @s slow_falling 1 255 true
