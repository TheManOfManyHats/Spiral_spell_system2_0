...
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon silverfish ~ ~ ~ {Tags:["offensive","summon","shifter","silverfish_horde","lv3","new_spell","chocolate_datapack_spell"],Attributes:[{Name:"generic.attack_damage",Base:0}]}
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon silverfish ~ ~ ~ {Tags:["offensive","summon","shifter","silverfish_horde","lv3","new_spell","chocolate_datapack_spell"],Attributes:[{Name:"generic.attack_damage",Base:0}]}
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon silverfish ~ ~ ~ {Tags:["offensive","summon","shifter","silverfish_horde","lv3","new_spell","chocolate_datapack_spell"],Attributes:[{Name:"generic.attack_damage",Base:0}]}
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon silverfish ~ ~ ~ {Tags:["offensive","summon","shifter","silverfish_horde","lv3","new_spell","chocolate_datapack_spell"],Attributes:[{Name:"generic.attack_damage",Base:0}]}
execute at @s[tag=1,scores={spell_power=3}] positioned ~ ~1.5 ~ run summon silverfish ~ ~ ~ {Tags:["offensive","summon","shifter","silverfish_horde","lv3","new_spell","chocolate_datapack_spell"],Attributes:[{Name:"generic.attack_damage",Base:0}]}
