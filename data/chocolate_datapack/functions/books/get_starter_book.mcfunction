...
give @s written_book{starterbook:1b,pages:['["",{"text":"Click below to bind your soul to an element.\\n\\n         "},{"text":"Fire","color":"dark_red","clickEvent":{"action":"run_command","value":"/trigger function set 1"},"hoverEvent":{"action":"show_text","contents":"Click to unlock the Fire spell tree."}},{"text":"\\n        ","color":"reset"},{"text":".","color":"white"},{"text":"Water","color":"dark_blue","clickEvent":{"action":"run_command","value":"/trigger function set 2"},"hoverEvent":{"action":"show_text","contents":"Click to unlock the Water spell tree."}},{"text":"\\n        ","color":"reset"},{"text":".","color":"white"},{"text":"Earth","color":"gold","clickEvent":{"action":"run_command","value":"/trigger function set 3"},"hoverEvent":{"action":"show_text","contents":"Click to unlock the Earth spell tree."}},{"text":"\\n          ","color":"reset"},{"text":"Air","color":"gray","clickEvent":{"action":"run_command","value":"/trigger function set 4"},"hoverEvent":{"action":"show_text","contents":"Click to unlock the Air spell tree."}},{"text":"\\n      ","color":"reset"},{"text":" ..","color":"white"},{"text":"Nature","color":"dark_green","clickEvent":{"action":"run_command","value":"/trigger function set 5"},"hoverEvent":{"action":"show_text","contents":"Click to unlock the Nature spell tree."}},{"text":"\\n     ","color":"reset"},{"text":" .","color":"white"},{"text":"Darkness","color":"reset","clickEvent":{"action":"run_command","value":"/trigger function set 6"},"hoverEvent":{"action":"show_text","contents":"Click to unlock the Darkness spell tree."}},{"text":"\\n       "},{"text":" ..","color":"white"},{"text":"Light","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger function set 7"},"hoverEvent":{"action":"show_text","contents":"Click to unlock the Light spell tree."}},{"text":"\\n        ","color":"reset"},{"text":"Space","color":"dark_purple","clickEvent":{"action":"run_command","value":"/trigger function set 8"},"hoverEvent":{"action":"show_text","contents":"Click to unlock the Space spell tree."}},{"text":"\\n     ","color":"reset"},{"text":".","color":"white"},{"text":"   ","color":"reset"},{"text":"Blade","color":"dark_gray","clickEvent":{"action":"run_command","value":"/trigger function set 9"},"hoverEvent":{"action":"show_text","contents":"Click to unlock the Blade spell tree."}}]'],title:"Strange Book",author:"???",generation:3,display:{Lore:["A strange book that just appeared in your hands. No sense in NOT reading it..."]}}