...
execute as @s[scores={spell1=223,spell_cooldown=0,jammed=0},tag=wild_slashes_unlocked] run function chocolate_datapack:spells/blade/wild_slashes
...
execute as @s[scores={spell1=235,spell_cooldown=0,jammed=0},tag=anti_magic_kounai_unlocked] run function chocolate_datapack:spells/blade/antimagic/antimagic_kounai
