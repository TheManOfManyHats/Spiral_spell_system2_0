...
execute at @s if entity @e[tag=atlas_key_door,distance=..1] run say "door interacted with"
execute at @s if entity @e[tag=atlas_key_door,distance=..1] run playsound minecraft:block.amethyst_block.resonate ambient @a ~ ~ ~ 1 2
execute at @s if entity @e[tag=atlas_key_door,distance=..1] run particle minecraft:glow ~ ~ ~ 0 0 0 .01 10 force
execute at @s if entity @e[tag=atlas_key_door,distance=..1] run kill @s
