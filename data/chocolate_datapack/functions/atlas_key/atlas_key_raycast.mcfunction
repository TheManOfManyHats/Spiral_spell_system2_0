...
execute at @s[tag=door_closed] positioned ^ ^ ^.1 positioned ~-.5 ~-2 ~-.5 if entity @e[tag=atlas_key_door,dy=4,dx=1,dz=1] at @s run playsound minecraft:block.amethyst_block.resonate ambient @a ~ ~ ~ 1 2
execute at @s[tag=door_closed] positioned ^ ^ ^.1 positioned ~-.5 ~-2 ~-.5 if entity @e[tag=atlas_key_door,dy=4,dx=1,dz=1] at @s run particle minecraft:glow ~ ~ ~ 0 0 0 .01 10 force
...
execute at @s[tag=door_opened] positioned ^ ^ ^.1 positioned ~-.5 ~-2 ~-.5 if entity @e[tag=atlas_key_door,dy=4,dx=1,dz=1] at @s run playsound minecraft:block.amethyst_block.resonate ambient @a ~ ~ ~ 1 2
execute at @s[tag=door_opened] positioned ^ ^ ^.1 positioned ~-.5 ~-2 ~-.5 if entity @e[tag=atlas_key_door,dy=4,dx=1,dz=1] at @s run particle minecraft:glow ~ ~ ~ 0 0 0 .01 10 force
