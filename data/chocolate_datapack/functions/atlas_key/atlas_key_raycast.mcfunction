...
execute at @s[tag=door_closed] positioned ^ ^ ^.1 positioned ~-.5 ~ ~-.5 as @e[tag=atlas_key_door,distance=..1.5] run tag @s add door_open
execute at @s[tag=door_closed] positioned ^ ^ ^.1 positioned ~-.5 ~ ~-.5 as @e[tag=atlas_key_door,distance=..1.5] run say "open is door"
execute at @s[tag=door_closed] positioned ^ ^ ^.1 positioned ~-.5 ~ ~-.5 if entity @e[tag=atlas_key_door,distance=..1.5] at @s run playsound minecraft:block.amethyst_block.resonate ambient @a ~ ~ ~ 1 2
execute at @s[tag=door_closed] positioned ^ ^ ^.1 positioned ~-.5 ~ ~-.5 if entity @e[tag=atlas_key_door,distance=..1.5] at @s run particle minecraft:glow ~ ~ ~ 0 0 0 .01 10 force
execute at @s[tag=door_closed] positioned ^ ^ ^.1 positioned ~-.5 ~ ~-.5 if entity @e[tag=atlas_key_door,distance=..1.5] run tag @s add 2
kill @s[tag=2]

execute at @s[tag=door_opened] positioned ^ ^ ^.1 positioned ~-.5 ~ ~-.5 as @e[tag=atlas_key_door,distance=..1.5] run tag @s remove door_open
execute at @s[tag=door_opened] positioned ^ ^ ^.1 positioned ~-.5 ~ ~-.5 as @e[tag=atlas_key_door,distance=..1.5] run say "close is door"
execute at @s[tag=door_opened] positioned ^ ^ ^.1 positioned ~-.5 ~ ~-.5 if entity @e[tag=atlas_key_door,distance=..1.5] at @s run playsound minecraft:block.amethyst_block.resonate ambient @a ~ ~ ~ 1 2
execute at @s[tag=door_opened] positioned ^ ^ ^.1 positioned ~-.5 ~ ~-.5 if entity @e[tag=atlas_key_door,distance=..1.5] at @s run particle minecraft:glow ~ ~ ~ 0 0 0 .01 10 force
execute at @s[tag=door_opened] positioned ^ ^ ^.1 positioned ~-.5 ~ ~-.5 if entity @e[tag=atlas_key_door,distance=..1.5] run tag @s add 2
kill @s[tag=2]
