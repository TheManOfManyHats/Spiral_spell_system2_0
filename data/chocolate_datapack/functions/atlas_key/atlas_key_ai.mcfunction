...
execute as @s[] if entity @a[nbt={Inventory:[{tag:{atlas_key:1b}}]},distance=..8] run tag @s add key_holder_near
execute as @s[] if entity @a[nbt={Inventory:[{tag:{atlas_key:1b}}]},distance=9..] run tag @s remove key_holder_near
