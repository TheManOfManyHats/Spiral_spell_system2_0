...
execute in chocolate_datapack_dimensions:atlas_key_realm as @e[tag=new_door,tag=atlas_key_door] run scoreboard players operation @s overworld_pos_x = @e[tag=step2,limit=1] atlas_key_pos_x
execute in chocolate_datapack_dimensions:atlas_key_realm as @e[tag=new_door,tag=atlas_key_door] run scoreboard players operation @s overworld_pos_y = @e[tag=step2,limit=1] atlas_key_pos_y
execute in chocolate_datapack_dimensions:atlas_key_realm as @e[tag=new_door,tag=atlas_key_door] run scoreboard players operation @s overworld_pos_z = @e[tag=step2,limit=1] atlas_key_pos_z

execute in chocolate_datapack_dimensions:atlas_key_realm as @e[tag=new_door,tag=atlas_key_door] run scoreboard players operation @s atlas_key_pos_x = @e[tag=step2,limit=1] overworld_pos_x
execute in chocolate_datapack_dimensions:atlas_key_realm as @e[tag=new_door,tag=atlas_key_door] run scoreboard players operation @s atlas_key_pos_y = @e[tag=step2,limit=1] overworld_pos_y
execute in chocolate_datapack_dimensions:atlas_key_realm as @e[tag=new_door,tag=atlas_key_door] run scoreboard players operation @s atlas_key_pos_z = @e[tag=step2,limit=1] overworld_pos_z
