...
execute as @e[tag=new_door,tag=atlas_key_door] run scoreboard players operation @s overworld_pos_x = @e[tag=step2,limit=1] atlas_key_pos_x
execute as @e[tag=new_door,tag=atlas_key_door] run scoreboard players operation @s overworld_pos_y = @e[tag=step2,limit=1] atlas_key_pos_y
execute as @e[tag=new_door,tag=atlas_key_door] run scoreboard players operation @s overworld_pos_z = @e[tag=step2,limit=1] atlas_key_pos_z

execute as @e[tag=new_door,tag=atlas_key_door] run scoreboard players operation @s atlas_key_pos_x = @e[tag=step2,limit=1] overworld_pos_x
execute as @e[tag=new_door,tag=atlas_key_door] run scoreboard players operation @s atlas_key_pos_y = @e[tag=step2,limit=1] overworld_pos_y
execute as @e[tag=new_door,tag=atlas_key_door] run scoreboard players operation @s atlas_key_pos_z = @e[tag=step2,limit=1] overworld_pos_z
...
execute as @e[tag=new_door,tag=atlas_key_door] store result entity @s Pos[0] int 1 run scoreboard players get @s overworld_pos_x
execute as @e[tag=new_door,tag=atlas_key_door] store result entity @s Pos[1] int 1 run scoreboard players get @s overworld_pos_y
