...
execute as @e[tag=new_door,tag=atlas_key_door,predicate=chocolate_datapack:in_lightfall] run tag @s add to_atlas
execute as @e[tag=new_door,tag=atlas_key_door,predicate=chocolate_datapack:in_lightfall] run tag @s add step_2
