...
execute as @s[tag=!end_room_forced] at @s positioned ~-7 ~-1 ~-7 run place template chocolate_datapack:ruined_shadowcat_dungeon_pieces/rsc_dungeon_church_e ~ ~ ~ none none
...
# up
execute as @s[tag=!end_room_forced] at @s positioned ~ ~9 ~ run summon marker ~ ~ ~ {Tags:["new_room","west_node"]}
