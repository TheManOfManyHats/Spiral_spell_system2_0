...
execute as @s[tag=!end_room_forced] at @s positioned ~-7 ~-1 ~-7 run place template chocolate_datapack:ruined_shadowcat_dungeon_pieces/rsc_dungeon_stairs_s ~ ~ ~ none none
...
tag @s[tag=!end_room_forced] add stairs_S
