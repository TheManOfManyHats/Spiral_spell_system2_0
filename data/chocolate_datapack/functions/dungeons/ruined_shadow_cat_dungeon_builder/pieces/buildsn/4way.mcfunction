execute if entity @e[type=marker,tag=dungeon_controller,scores={max_room_sumber=..0}] run tag @s add end_room_forced
...
tag @s remove north_sode
execute as @e[tag=dungeon_controller] run scoreboard players remove @s max_room_sumber 1
