...
execute as @s[scores={room_varience=0},tag=!end_room_forced] at @s positioned ~-7 ~-1 ~-7 run place template chocolate_datapack:ruined_shadowcat_dungeon_pieces/rsc_dungeon_corner1_se ~ ~ ~ none none
