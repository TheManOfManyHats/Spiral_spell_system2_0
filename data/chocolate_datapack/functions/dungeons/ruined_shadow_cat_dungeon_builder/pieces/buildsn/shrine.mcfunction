...
execute as @s[tag=!end_room_forced] at @s positioned ~-7 ~-10 ~-7 run place template chocolate_datapack:ruined_shadowcat_dungeon_pieces/rsc_dungeon_shrine_n ~ ~ ~ none none
