...
execute as @s[scores={spell1=269,spell_cooldown=0,jammed=0},tag=silverfish_horde_unlocked] run function chocolate_datapack:spells/shifter/silverfish_horde_unlocked
