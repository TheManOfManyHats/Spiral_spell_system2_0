...
execute as @s[scores={spell4=166,spell_cooldown=0,jammed=0},tag=light_step_unlocked] run function chocolate_datapack:spells/light/light_step
...
execute as @s[scores={spell4=223,spell_cooldown=0,jammed=0},tag=blade_slashes_unlocked] run function chocolate_datapack:spells/blade/wild_slashes
...
execute as @s[scores={spell4=247,spell_cooldown=0,jammed=0},tag=aerobatics_unlocked] run function chocolate_datapack:spells/staff_spells/acrobat/aerobatics
execute as @s[scores={spell4=248,spell_cooldown=0,jammed=0},tag=bullet_stroke_unlocked] run function chocolate_datapack:spells/staff_spells/acrobat/bullet_stroke
execute as @s[scores={spell4=249,spell_cooldown=0,jammed=0},tag=freerun_unlocked] run function chocolate_datapack:spells/staff_spells/acrobat/freerun

execute as @s[scores={spell4=250,spell_cooldown=0,jammed=0},tag=luke_spell_free_hand_unlocked] run function chocolate_datapack:spells/luke_spells/free_hand
execute as @s[scores={spell4=251,spell_cooldown=0,jammed=0},tag=luke_spell_summon_boat_unlocked] run function chocolate_datapack:spells/luke_spells/summon_boat
execute as @s[scores={spell4=252,spell_cooldown=0,jammed=0},tag=luke_spell_skelton_horse_unlocked] run function chocolate_datapack:spells/luke_spells/summon_horse
execute as @s[scores={spell4=253,spell_cooldown=0,jammed=0},tag=luke_spell_transmutiation_unlocked] run function chocolate_datapack:spells/luke_spells/transmutation
execute as @s[scores={spell4=254,spell_cooldown=0,jammed=0},tag=luke_spell_summon_golem_unlocked] run function chocolate_datapack:spells/luke_spells/summon_golem
execute as @s[scores={spell4=255,spell_cooldown=0,jammed=0},tag=luke_spell_gale_wings_unlocked] run function chocolate_datapack:spells/luke_spells/gale_wings
execute as @s[scores={spell4=256,spell_cooldown=0,jammed=0},tag=luke_spell_bastion_pauldrons_unlocked] run function chocolate_datapack:spells/luke_spells/bastion_pauldrons
...
execute as @s[scores={spell1=264,spell_cooldown=0,jammed=0},tag=aerial_shape__unlocked] run function chocolate_datapack:spells/shifter/aerial_shape
execute as @s[scores={spell1=265,spell_cooldown=0,jammed=0},tag=chameleon_skin__unlocked] run function chocolate_datapack:spells/shifter/chameleon_skin
execute as @s[scores={spell1=266,spell_cooldown=0,jammed=0},tag=wraith_walker__unlocked] run function chocolate_datapack:spells/shifter/wraith_walker
