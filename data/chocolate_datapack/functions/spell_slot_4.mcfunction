...
execute as @s[scores={spell4=226,spell_cooldown=0,jammed=0},tag=wind_slash_unlocked] run function chocolate_datapack:spells/blade/spellsword/wind_slash
...
execute as @s[scores={spell4=235,spell_cooldown=0,jammed=0},tag=anti_magic_kounai_unlocked] run function chocolate_datapack:spells/blade/antimagic/antimagic_kounai
