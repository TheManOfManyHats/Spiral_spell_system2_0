...
clear @s[tag=1] stick{Pendant:1b,Consumable:1b,CustomModelData:515,display:{Name:'["",{"text":"Pendant","italic":false,"color":"gold"}]',Lore:['["",{"text":"A strange Pendant","italic":false,"color":"dark_red"}]','["",{"text":"that feels warm to the touch.","italic":false,"color":"dark_red"}]','[""]','["",{"text":"Right click to equip!","italic":false,"color":"gray"}]','["",{"text":"+Wil Regeneration","italic":false,"color":"dark_green"}]']}} 1
