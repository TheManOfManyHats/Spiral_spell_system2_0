...
clear @s[tag=1] stick{Black_ring:1b,Consumable:1b,CustomModelData:533,display:{Lore:['["",{"text":"A ring with a Black Pearl","italic":false,"color":"dark_red"}]','["",{"text":"Slotted into it.","italic":false,"color":"dark_red"}]','[""]','["",{"text":"Right click to equip!","italic":false,"color":"gray"}]','["",{"text":"+Fortification","italic":false,"color":"dark_green"}]'],Name:'{"extra":[{"bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false,"color":"gold","text":"Black Ring"}],"text":""}'}} 1
