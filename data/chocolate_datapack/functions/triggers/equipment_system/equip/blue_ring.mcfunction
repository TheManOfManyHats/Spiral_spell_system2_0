...
clear @s[tag=1] stick{Blue_ring:1b,Consumable:1b,CustomModelData:529,display:{Name:'["",{"text":"Blue Ring","italic":false,"color":"gold"}]',Lore:['["",{"text":"A ring with a Blue Pearl","italic":false,"color":"dark_red"}]','["",{"text":"Slotted into it.","italic":false,"color":"dark_red"}]','[""]','["",{"text":"Right click to equip!","italic":false,"color":"gray"}]','["",{"text":"+Strength","italic":false,"color":"dark_green"}]']}} 1
