...
clear @s[tag=1] stick{Green_ring:1b,Consumable:1b,CustomModelData:532,display:{Name:'["",{"text":"Green Ring","italic":false,"color":"gold"}]',Lore:['["",{"text":"A ring with a Green Pearl","italic":false,"color":"dark_red"}]','["",{"text":"Slotted into it.","italic":false,"color":"dark_red"}]','[""]','["",{"text":"Right click to equip!","italic":false,"color":"gray"}]','["",{"text":"+Spell Cooldown","italic":false,"color":"dark_green"}]']}} 1
