...
execute as @s[scores={function=932}] run function chocolate_datapack:spells/shifter/unlocks/unlock_aquatic_form
...
execute as @s[scores={function=1262},tag=aquatic_form_unlocked] run scoreboard players set @s spell1 262
...
execute as @s[scores={function=2262},tag=aquatic_form_unlocked] run scoreboard players set @s spell1 262
...
execute as @s[scores={function=3262},tag=aquatic_form_unlocked] run scoreboard players set @s spell1 262
...
execute as @s[scores={function=4262},tag=aquatic_form_unlocked] run scoreboard players set @s spell1 262
...
execute as @s[scores={function=5262},tag=aquatic_form_unlocked] run scoreboard players set @s spell1 262
