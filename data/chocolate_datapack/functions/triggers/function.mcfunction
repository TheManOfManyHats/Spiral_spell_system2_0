...
execute as @s[scores={function=138}] run give @s netherite_sword{CustomModelData:67,dungeon_relic:1b,null_blade:1b,display:{Name:'["",{"text":"Null Blade ","italic":false,"color":"gold"},{"text":"[Relic]","italic":false,"color":"dark_green"}]',,Lore:['["",{"text":"This Sword feels... empty? In fact","italic":false}]','["",{"text":"as you hold it, you can feel your","italic":false}]','["",{"text":"own Wil being consumed just by","italic":false}]','["",{"text":"having it in your hands.","italic":false}]','["",{"text":"This effect might be able to be","italic":false}]','["",{"text":"extended away from the blade if","italic":false}]','["",{"text":"you can channel it properly.","italic":false}]','[""]','["",{"text":"Right Click:","italic":false,"color":"gray"}]','["",{"text":"+Antimagic Slash","italic":false,"color":"dark_green"}]','["",{"text":"Shift Right Click:","italic":false,"color":"gray"}]','["",{"text":"+Draining Zone","italic":false,"color":"dark_green"}]','["",{"text":"Shift Left Click:","italic":false,"color":"gray"}]','["",{"text":"+Draining Crescent Slash","italic":false,"color":"dark_green"}]','["",{"text":"Shift Jump:","italic":false,"color":"gray"}]','["",{"text":"+Null Zone","italic":false,"color":"dark_green"}]']},Enchantments:[{lvl:10,id:efficiency},{lvl:10,id:unbreaking}],Unbreakable:1,AttributeModifiers:[{AttributeName:"generic.attack_damage",Amount:20,Slot:mainhand,UUID:[I;-124815,129929,132318,-259858],Name:1726426777337}],HideFlags:63}
