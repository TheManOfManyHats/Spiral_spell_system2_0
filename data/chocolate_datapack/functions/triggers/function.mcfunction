...
execute as @s[scores={function=141}] run give @s stick{itemsadder: {id: "atlas_key", namespace: "myitems"},CustomModelData:1112,dungeon_relic:1b,atlas_key:1b,display:{Name:'["",{"text":"Atlas Key ","italic":false,"color":"gold"},{"text":"[Relic]","italic":false,"color":"dark_green"}]',Lore:['["",{"text":"This key seems to vibrate with","italic":false}]','["",{"text":"at certain frequency. You feel","italic":false}]','["",{"text":"as though whoever made it did","italic":false}]','["",{"text":"not intend for it to open any","italic":false}]','["",{"text":"normal door. It was made with","italic":false}]','["",{"text":"the intent to create doors and","italic":false}]','["",{"text":"travel between them.","italic":false}]','[""]','["",{"text":"Right Click on ground:","italic":false,"color":"gray"}]','["",{"text":"Create new door","italic":false,"color":"dark_green"}]','["",{"text":"(Cannot be used within 64","italic":false,"color":"gold"}]','["",{"text":"blocks of existing door!)","italic":false,"color":"gold"}]','["",{"text":"Right Click on existing door:","italic":false,"color":"gray"}]','["",{"text":"Open Door","italic":false,"color":"dark_green"}]','["",{"text":"Shift Left Click:","italic":false,"color":"gray"}]','["",{"text":"Remove Existing Door","italic":false,"color":"dark_green"}]','["",{"text":"Shift Right Click:","italic":false,"color":"gray"}]','["",{"text":"Emergency Exit","italic":false,"color":"dark_green"}]']}}
