...
execute as @s[scores={spell3=166,spell_cooldown=0,jammed=0},tag=solar_flare_unlocked] run function chocolate_datapack:spells/light/solar_flare
...
execute as @s[scores={spell3=226,spell_cooldown=0,jammed=0},tag=wind_slash_unlocked] run function chocolate_datapack:spells/blade/spellsword/wind_slash
...
execute as @s[scores={spell3=235,spell_cooldown=0,jammed=0},tag=anti_magic_kounai_unlocked] run function chocolate_datapack:spells/blade/antimagic/antimagic_kounai
