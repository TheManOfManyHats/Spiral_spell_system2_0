...
#LIGHT_STEP #1
execute as @s[tag=light_step] at @s rotated as @s unless block ^ ^ ^.5 #chocolate_datapack:passthrough run function chocolate_datapack:spells/light/light_step_effect_on_block
